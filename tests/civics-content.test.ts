...
describe("公共・政治経済の収録教材", () => {
  ...
  it("出典区分ごとの内訳を記録する（配分が変わったら気づけるように）", () => {
    ...
    // 新課程「公共，政治・経済」116問
    //（令和8年度追試験31問、令和8年度本試験26問、令和7年度追試験31問、令和7年度本試験28問）／
    // 旧課程の共通テスト「政治・経済」216問
    //（令和7年度「旧政治・経済」3問、令和6年度26問、令和6年度追試験29問、令和5年度24問、
    //  令和5年度追試験28問、令和4年度16問、令和4年度追試験32問、令和3年度第1日程27問、
    //  令和3年度第2日程31問）／
    // センター試験「政治・経済」384問
    //（令和2年度本試験31問＝図そのものを読む3問を除く、平成31年度本試験32問＝図そのものを読む2問を除く、
    //  平成30年度本試験34問＝全設問を収録、平成29年度本試験33問＝図そのものを読む1問を除く、
    //  平成28年度本試験34問＝全設問を収録、平成27年度本試験35問＝図そのものを読む1問を除く、
    //  平成26年度本試験35問＝図そのものを読む1問を除く、平成25年度本試験36問＝全設問を収録、
    //  平成24年度本試験38問＝全設問を収録、平成23年度本試験38問＝全設問を収録、
    //  平成22年度本試験38問＝全設問を収録）。
    expect(counts).toEqual({ "common-new": 116, "common-legacy": 216, center: 384 });
  });
});
